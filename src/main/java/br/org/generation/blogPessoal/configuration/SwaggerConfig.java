	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						...
						.contact(new Contact().name("Filipe Cavalcanti")
								.url("https://github.com/filipe-cavalcanti")
								.email("filipe-cavalcanti@outlook.com")))
				.externalDocs(
						new ExternalDocumentation().description("GitHub").url("https://github.com/filipe-cavalcanti"));
	}
